...
public class DisplayOverlayWaystoneProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		return (world.getBlockState(
				...
				&& ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(UnusualEnd.makeUEID("can_teleport_to_warping_waystone")))
						|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).is(ItemTags.create(UnusualEnd.makeUEID("can_teleport_to_warping_waystone"))))
