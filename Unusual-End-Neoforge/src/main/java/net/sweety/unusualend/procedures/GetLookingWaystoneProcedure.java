...
public class GetLookingWaystoneProcedure {
    public static boolean execute(LevelAccessor world, LivingEntity entity) {
        if (entity == null)
            return false;
        return (world.getBlockState(
                ...
                && (entity.getMainHandItem().is(ItemTags.create(UnusualEnd.makeUEID("can_teleport_to_warping_waystone")))
                || entity.getOffhandItem().is(ItemTags.create(UnusualEnd.makeUEID("can_teleport_to_warping_waystone"))));
    }
}
