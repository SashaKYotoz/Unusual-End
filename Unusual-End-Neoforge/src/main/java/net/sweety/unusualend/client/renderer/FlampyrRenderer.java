...
import net.sweety.unusualend.client.model.ModelBabyFlampyr;
...
public class FlampyrRenderer extends MobRenderer<FlampyrEntity, ModelFlampyr<FlampyrEntity>> {
    ...
    private final ResourceLocation FLAMPYR = UnusualEnd.makeUEID("textures/entities/flampyr.png");
    private final ResourceLocation BABY_FLAMPYR = UnusualEnd.makeUEID("textures/entities/baby_flampyr.png");
    private final ResourceLocation GLOWING_FLAMPYR = UnusualEnd.makeUEID("textures/entities/flampyr_glow_layer.png");
    private final ResourceLocation GLOWING_BABY_FLAMPYR = UnusualEnd.makeUEID("textures/entities/baby_flampyr_glow.png");
