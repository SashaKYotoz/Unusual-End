...
public class WarpedChestOnRandomClientDisplayTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!(new Object() {
			...
			world.addParticle(UnusualendModParticleTypes.BOLOK_PARTICLE.get(), (x + Mth.nextDouble(RandomSource.create(), -0.1, 1.1)), (y + Mth.nextDouble(RandomSource.create(), 0.4, 0.85)),
					(z + Mth.nextDouble(RandomSource.create(), -0.1, 1.1)), 0, 0, 0);
			if (Math.random() < 0.3) {
				world.addParticle(UnusualendModParticleTypes.WARPED_BUBBLES.get(), (x + Mth.nextDouble(RandomSource.create(), 0.2, 0.8)), (y + Mth.nextDouble(RandomSource.create(), 0.7, 0.85)),
