	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), SoundEvents.BOOK_PAGE_TURN, SoundSource.PLAYERS, 1, 1);
			} else {
				_level.playLocalSound(x, y, z, SoundEvents.BOOK_PAGE_TURN, SoundSource.PLAYERS, 1, 1, false);
			}
		}
