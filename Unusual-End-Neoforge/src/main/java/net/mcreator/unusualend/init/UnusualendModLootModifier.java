...
public class UnusualendModLootModifier {
	...
	public static final DeferredRegister<Codec<? extends IGlobalLootModifier>> LOOT_MODIFIERS = DeferredRegister.create(NeoForgeRegistries.GLOBAL_LOOT_MODIFIER_SERIALIZERS, "unusualend");
	public static final DeferredHolder<Codec<? extends IGlobalLootModifier>, Codec<UnusualendModLootTableModifier>> LOOT_MODIFIER = LOOT_MODIFIERS.register("unusualend_loot_modifier", UnusualendModLootTableModifier.CODEC);
}
