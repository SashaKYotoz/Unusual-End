...
public class LeechingChargeProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public LeechingChargeProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(UnusualendModEntities.LEECHING_CHARGE_PROJECTILE.get(), world);
	}
	...
	public LeechingChargeProjectileEntity(EntityType<? extends LeechingChargeProjectileEntity> type, double x, double y, double z, Level world) {
	...
	public static LeechingChargeProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
