...
import net.mcreator.unusualend.procedures.ShinyGrenadeProjectileProjectileHitsBlockProcedure;
...
public class ShinyGrenadeProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public ShinyGrenadeProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(UnusualendModEntities.SHINY_GRENADE_PROJECTILE.get(), world);
	}
	...
	public ShinyGrenadeProjectileEntity(EntityType<? extends ShinyGrenadeProjectileEntity> type, double x, double y, double z, Level world) {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		ShinyGrenadeProjectileProjectileHitsBlockProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		ShinyGrenadeProjectileProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
