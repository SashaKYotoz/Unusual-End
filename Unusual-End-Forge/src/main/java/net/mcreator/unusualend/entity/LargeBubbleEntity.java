...
public class LargeBubbleEntity extends Animal {
	public LargeBubbleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UnusualendModEntities.WARPED_BALLOON.get(), world);
	}
	...
	public double getPassengersRidingOffset() {
		return super.getPassengersRidingOffset() + -1.1;
	}
