...
public class BlockUpdaterEntity extends PathfinderMob {
	public BlockUpdaterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UnusualendModEntities.BLOCK_UPDATER.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		AncientEndCityStructureOnStructureInstanceGeneratedProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
