...
public class WarpedBalloonProjEntity extends AbstractArrow implements ItemSupplier {
	...
	public WarpedBalloonProjEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(UnusualendModEntities.WARPED_BALLOON_PROJ.get(), world);
	}
	...
	public WarpedBalloonProjEntity(EntityType<? extends WarpedBalloonProjEntity> type, double x, double y, double z, Level world) {
