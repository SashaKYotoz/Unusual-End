...
public class UnusualendModJeiPlugin implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		List<BolokTradingRecipe> BolokTradingRecipes = recipeManager.getAllRecipesFor(BolokTradingRecipe.Type.INSTANCE);
		registration.addRecipes(BolokTrading_Type, BolokTradingRecipes);
		List<InfuserRecipe> InfuserRecipes = recipeManager.getAllRecipesFor(InfuserRecipe.Type.INSTANCE);
