...
public class BolokNotesButtonMessage {
	...
	public static void buffer(BolokNotesButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BolokNotesButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
