...
public class InfuserRecipe implements Recipe<SimpleContainer> {
	...
	public static class Serializer implements RecipeSerializer<InfuserRecipe> {
		...
		public static final ResourceLocation ID = new ResourceLocation("unusualend", "infuser");
		...
		@Override
		public @Nullable InfuserRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
