					...
					UnusualendMod.queueServerWork(4, () -> {
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								...
								_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.note_block.flute")), SoundSource.BLOCKS, (float) 0.3, (float) (Mth.nextDouble(RandomSource.create(), 50, 70) * 0.01),
										false);
							}
						}
					});
