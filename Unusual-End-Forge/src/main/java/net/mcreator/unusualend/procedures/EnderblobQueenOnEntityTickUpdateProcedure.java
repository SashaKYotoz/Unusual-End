...
public class EnderblobQueenOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof EnderblobQueenEntity) {
			...
			if (entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(UnusualendModMobEffects.ENDER_INFECTION.get())) {
				if (entity instanceof LivingEntity _entity)
		...
		if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
			...
			if (entity.getPersistentData().getDouble("IA") == 100) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.death")), SoundSource.HOSTILE, 2, (float) 0.5);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.death")), SoundSource.HOSTILE, 2, (float) 0.5, false);
					}
				}
				...
				if (!((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null)) {
					if ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) instanceof LivingEntity _entity && !_entity.level().isClientSide())
						_entity.addEffect(new MobEffectInstance(UnusualendModMobEffects.CRYSTALLIZATION.get(), 100, 0, false, false));
					for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 2, 3); index0++) {
						if (world instanceof Level _level) {
							if (!_level.isClientSide()) {
								_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.step")), SoundSource.NEUTRAL, 1, (float) 0.75);
							} else {
								_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.step")), SoundSource.NEUTRAL, 1, (float) 0.75, false);
							}
						}
					}
					...
					if (dis >= 7) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (UnusualendModParticleTypes.PINK_FLAME.get()), ((entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null).getX()),
			...
			if (entity.getPersistentData().getDouble("IA") == 300) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.hurt")), SoundSource.HOSTILE, 2, (float) 0.5);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.hurt")), SoundSource.HOSTILE, 2, (float) 0.5, false);
					}
				}
				QueenBreakSurroundingsProcedure.execute(world, x, y, z);
				if (world instanceof ServerLevel _level)
					_level.sendParticles((SimpleParticleType) (UnusualendModParticleTypes.PINK_FLAME.get()), x, y, z, 30, 2, 2, 2, 0.1);
				if (world instanceof ServerLevel _level)
			...
			if (entity.getPersistentData().getDouble("IA") == 340) {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.respawn_anchor.set_spawn")), SoundSource.NEUTRAL, 3, 2);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.respawn_anchor.set_spawn")), SoundSource.NEUTRAL, 3, 2, false);
					}
				}
						...
						if (!entityiterator.getType().is(TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("forge:blobqueen_immune")))) {
							...
							if (!world.isClientSide()) {
								if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
									_entity.addEffect(new MobEffectInstance(UnusualendModMobEffects.ENDER_INFECTION.get(), 400, 0, false, false));
								if (entityiterator instanceof LivingEntity _entity && !_entity.level().isClientSide())
									_entity.addEffect(new MobEffectInstance(UnusualendModMobEffects.CRYSTALLIZATION.get(), 100, 0, false, false));
							}
							entityiterator.invulnerableTime = 0;
			...
			if (entity.getPersistentData().getDouble("IA") == 400) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.ambient")), SoundSource.HOSTILE, 2, (float) 0.7);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.endermite.ambient")), SoundSource.HOSTILE, 2, (float) 0.7, false);
					}
				}
				loop = 1;
				particleAmount = 3;
