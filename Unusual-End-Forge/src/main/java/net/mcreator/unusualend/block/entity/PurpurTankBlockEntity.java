...
public class PurpurTankBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("purpur_tank");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new PurpurTankGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
